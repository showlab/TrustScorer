...
from assistgui.model_zoo.qwen import init_qwen_vl_chat, run_qwen_vl_chat
...
class SharedModel:
    ...
    def init_ofa(cls, **kwargs):
        ...
        def load_ofa():
            ...
            overrides = {"bpe_dir": "/workspace/assistgui/models/OFA/utils/BPE"}
            models, cfg, task = checkpoint_utils.load_model_ensemble_and_task(
                utils.split_paths('/workspace/assistgui/models/OFA/checkpoints/refcocog.pt'),
